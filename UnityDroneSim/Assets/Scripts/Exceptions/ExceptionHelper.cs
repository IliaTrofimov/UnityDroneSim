...
namespace Exceptions
{
    public static class ExceptionHelper
    {
        ...
        {
            if (obj == null) 
                throw new MissingComponentException($"Missing component '{componentName}' of type {typeof(TImport).Name}.");
        }
        ...
        {
            if (obj == null) 
                throw new MissingComponentException($"Parent object {typeof(TParent).Name} is missing component '{componentName}' of type {typeof(TImport).Name}.");
        } 
        ...
        {
            if (obj == null) 
                throw new MissingComponentException($"Parent object {typeof(TParent).Name} is missing component of type {typeof(TImport).Name}.");
        } 
    }
}